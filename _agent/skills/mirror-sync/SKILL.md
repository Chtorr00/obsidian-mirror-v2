...
This skill automates the pipeline for transforming raw foresight batches into a polished, searchable web mirror.
...
- **Source Articles**: A markdown document (e.g., "March Articles.md") with multiple articles or individual project files in the **Obsidian Archive** (`Weblog-Sources/articles/`).
...
2. **Ingestion & Splitting**: Segment mass-ingestion files and populate the **Obsidian Archive** path.
